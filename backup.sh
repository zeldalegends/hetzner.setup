...
tar cz . | openssl enc -aes-256-cbc -e -out $FILENAME.encrypted.tar.gz
...
# IP=$(curl -s http://whatismyip.akamai.com/) # https://ifconfig.me/
...
echo -e "\033[0;33mDecript and uncompress: openssl aes-256-cbc -d -in $FILENAME.encrypted.tar.gz | tar xzv\033[0m"
